...
def main(hparams) -> None:
    ...
    # ------------------------
    model = LONGFORMERRegression(hparams)
    ...
    # ------------------------
    trainer = Trainer(
        logger=LongformerUtils.setup_testube_logger(),
...
if __name__ == "__main__":
    ...
    parser = HyperOptArgumentParser(strategy="random_search",
                                    description="Minimalist BERT Regression",
                                    add_help=True)
    ...
    parser.add_argument("--val_percent_check",
                        ...
                        type=float,
                        help=(
                            "If you don't want to use the entire dev set (for debugging or if it's huge), "
                            "set how much of the dev set you want to use with this flag."
                        ))

    # each LightningModule defines arguments relevant to it
    parser = LONGFORMERRegression.add_model_specific_args(parser)
    ...
    hparams.train_csv = '../../data/fold_0/train.tsv'
    hparams.dev_csv = '../../data/fold_0/dev.tsv'
    hparams.test_csv = '../../data/fold_0/dev.tsv'
